...
- **12 PDF documents** currently tracked
...
| --- | --- |
| [Apple_Platform_Security_Guide](Apple_Platform_Security_Guide/) | Historical Apple Platform Security Guide editions from **2019–2026**, plus a link to Apple's live online guide |
| [Personal_Safety_User_Guide](Personal_Safety_User_Guide/) | Apple personal safety guidance across multiple releases |
| [iOS](iOS/) | Archived iOS Security Guide documents from older platform generations |
| [macOS](macOS/) | macOS / OS X security overviews, core technology material, and Apple T2 related documents |
| [FaceID](FaceID/) | Face ID security guides from early release periods |
| [Differential_Privacy](Differential_Privacy/) | Apple material on differential privacy and privacy-preserving learning at scale |
| [CSAM](CSAM/) | CSAM / PSI technical summaries, protocol analysis, and external assessments |
| [COVID-19_ContactTracing](COVID-19_ContactTracing/) | Exposure Notification privacy-preserving analytics material |
| [sideload](sideload/) | Apple documents discussing the security implications of sideloading |
...
- **Live reference included:** [`Apple_Platform_Security_Guide/README.md`](Apple_Platform_Security_Guide/README.md) points to Apple's current online guide
